...
type ValidCronField<F extends string, PossibleValues extends string> = F extends PossibleValues
  ? F
  : F extends CronAnyValue
    ? F
    : F extends ValidCronStep<F, PossibleValues>
      ? F
      : F extends ValidCronRange<F, PossibleValues>
        ? F
        : never;
    ...
    ? B extends ValidCronField<B, CronHour>
      ? C extends ValidCronField<C, CronDayMonth>
        ? D extends ValidCronField<D, CronMonth>
          ? E extends ValidCronField<E, CronDayWeek>
            ? T
            : never
          : never
        : never
